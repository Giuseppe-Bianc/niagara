...
// configuration step. It creates a namespace called `niagara`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", niagara::cmake::project_name, niagara::cmake::project_version) };
